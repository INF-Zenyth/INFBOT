...
client.on("ready", () => {
    ...
    console.log(`INFBOT ${version} Online • ${client.members.cache.size} users • ${client.channels.cache.size} channels • ${client.guilds.cache.size} servers`);
});
...
function botcommand(message) {
    ...
    let Embed = new Discord.MessageEmbed()
        ...
        .addFields(
            ...
            { name: "Users", value: `${client.members.cache.size} users`, inline: true},
